 ...
 * DOM Element.
 */
declare type DOMElement = HTMLElement;
/**
 ...
 */
export declare function createElement<A extends Attributes>(jsxElement: Elements.Element<Parameters<A>>): (DOMElement | Text)[];
/**
